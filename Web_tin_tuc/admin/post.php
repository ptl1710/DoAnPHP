    ...
    <div id="page-inner">
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="post_update.php?id=<?php echo $id; ?>">Cập Nhật</a> | <a
                            href="post_remove.php?id=<?php echo $id; ?>">Xóa</a></td>
                </tr>
                <?php
				}
				?>
        ...
        <ul class="pagination">
			...
			if ($current_page > 1 && $total_page > 1) {
				echo '<li><a href="post.php?page=' . ($current_page - 1) . '">Lùi Lại</a></li>';
			}
			...
			if ($current_page < $total_page && $total_page > 1) {
				echo '<li><a href="post.php?page=' . ($current_page + 1) . '">Tiếp Theo</a></li>';
			}
